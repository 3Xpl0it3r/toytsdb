...
func Test_diskWAL_append_read(t *testing.T) {
	var (
		op   = operationInsert
		rows = []Row{
			{Metric: "metric-1", Sample: Sample{Value: 0.1, Timestamp: 1600000000}},
			{Metric: "metric-2", Sample: Sample{Value: 0.2, Timestamp: 1600000001}},
			{Metric: "metric-1", Sample: Sample{Value: 0.1, Timestamp: 1600000001}},
			{Metric: "metric-2", Sample: Sample{Value: 0.2, Timestamp: 1600000003}},
		}
	)
